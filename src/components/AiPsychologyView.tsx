...
export default function AiPsychologyView({ student }: { student: Student }) {
  ...
  const radarChartData = useMemo(() => {
    ...
    return [
      { subject: "تمرکز شناختی (پومودورو)", A: p.focusIndex, fullMark: 100 },
      { subject: "تاب‌آوری روانی (کایزن)", A: p.resilience, fullMark: 100 },
      { subject: "اشتیاق و انرژی درونی", A: p.academicDrive, fullMark: 100 },
      { subject: "پایداری ذهنی (استقامت)", A: p.stamina, fullMark: 100 },
      { subject: "مدیریت اضطراب آزمون", A: p.anxietyManagement, fullMark: 100 },
      { subject: "کیفیت خواب و ریکاوری", A: p.sleepEfficacy, fullMark: 100 }
    ];
  }, [currentReport]);
